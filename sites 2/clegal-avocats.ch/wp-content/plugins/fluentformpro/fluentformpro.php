...
update_option('_ff_fluentform_pro_license_key', 'f1fb4002-bca7-488e-b3a4-7c67e635ef21');
update_option('_ff_fluentform_pro_license_status', 'valid');

define('FLUENTFORMPRO', true);
define('FLUENTFORMPRO_VERSION', '6.1.0');
...
if (!class_exists('FluentFormPro')) {
    ...
    class FluentFormPro
    {
        ...
        public function registerScripts()
        {
            ...
            wp_register_script('intlTelInput', FLUENTFORMPRO_DIR_URL . 'public/libs/intl-tel-input/js/intlTelInput.min.js', [], '24.2.0', true);
